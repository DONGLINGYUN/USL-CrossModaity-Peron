...
def main_worker(args):
    ...
    for trial in range(1, 11):  # (1,11):
        ...
        checkpoint = load_checkpoint(
            "E:\SSL\label_graph\logs\model_best.pth.tar")
        #
        ...
        query_img, query_label = process_test_regdb(data_path, trial=trial, modal='thermal')#visible
        gall_img, gall_label = process_test_regdb(data_path, trial=trial, modal='visible')#thermal
    ...
    #     model = create_model(args)
    #     checkpoint = load_checkpoint(
    #         "E:\SSL\label_graph\logs\\regdb_s2_baseline\\1\model_best.pth.tar")
    #
    #     model.load_state_dict(remove_classifier(checkpoint['state_dict']), strict=False)
    #
